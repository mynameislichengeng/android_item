...
public class PieChartView extends View implements Runnable {
	...
	// 默认颜色
	private static final String[] DEFAULT_ITEMS_COLORS = { "#fe5513",
			"#ff8400", "#E56405", "#fdbd35", "#f0d72d", "#9dc62f", "#4164fb","#F37233", "#ED5823", "#E94221", "#BD1B13",
			"#1570fa", "#03a9d2", "#00ce7e", "#9dc317", "#ddcb00", "#eea904",
			"#fe7613", "#fda635", 
			"#E23343" };
	
	private static final String[] DEFAULT_ITEMS_COLORSGRAY = { "#949494",
		"#949494", "#949494", "#949494", "#949494", "#949494", "#949494","#949494", "#949494", "#949494", "#949494",
...
//	private int totalNum;
	...
	public void setItemsSizes(float[] items) {
		if (items != null && items.length > 0) {
			...
			reSetTotal();
			refreshItemsAngs();
			if(items.length==1&&totalNum==0){
				itemsColors=DEFAULT_ITEMS_COLORSGRAY;
			}
...
//			drawImg(canvas, centerX, centerY, radius / 2);
	...
	private void drawText(Canvas canvas, float x, float y, int radius) {
		...
		canvas.translate(x - (radius / 1.5f), y+10);
...
//				if(totalNum==0){
//					System.arraycopy(DEFAULT_ITEMS_COLORSGRAY, 0, itemsColors, 0,
//							itemsColors.length);
//				}else {
