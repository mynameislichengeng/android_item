 ...
 * 
 */
public class CopyOfPieChartActivity extends BaseActivity implements OnDateChangedLinstener {
	...
	private Handler handler = new Handler(new Handler.Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			case 1:
				...
				mView = new StatisticsView(CopyOfPieChartActivity.this, items, total, type, items_vlaue);
				...
				mView.setDateChangedListener(CopyOfPieChartActivity.this);
			...
			case 2:
				...
				Toast.makeText(CopyOfPieChartActivity.this, returnMessage, Toast.LENGTH_SHORT).show();
				total = 0;
				items = new float[1];
				items[0] = 100;
				items_vlaue = new float[1];
