...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF00085d0;
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			// valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0x00ffffff);
		}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		int m = getWidth() / 5;
		centerDrawable.setBounds(0 + m, center - offset, getWidth() - m, center
				- offset + MyDimensAdapter.setCurrentSize(2));
