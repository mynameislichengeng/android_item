...
public class SnsService extends Service{
	 ...
	 * */
	public static final String ACTION_SERVICE_STOP = "com.haoqee.haoqeechatsdk.sns.service.ACTION_SERVICE_STOP";
	/**
	 ...
	 * */
	public static final String ACTION_REQUEST = "com.haoqee.haoqeechatsdk.sns.service.ACTION_REQUEST";
	/**
	 ...
	 * */
	public static final String ACTION_RESULT = "com.haoqee.haoqeechatsdk.sns.service.ACTION_RESULT";
	 ...
	 */
	public static final String ACTION_CONNECT_CHANGE = "com.haoqee.haoqeechatsdk.sns.service.ACTION_CONNECT_CHANGE";
    ...
    private String mUid = "";				//登录用户ID
    private String mPassword = "";			//登录用户密码
    private LoginListenser mListenser;		//监听登录状态类 
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if(intent != null){
			...
			mListenser = TCChatManager.getInstance().getLoginListenser();
		}
		
		if(!TextUtils.isEmpty(mUid)){
			try {
				xmppManager = new XmppManager(this, mUid, mPassword, mListenser);
				xmppManager.setHost(host, port, resourceName);
			} catch (Exception e) {
