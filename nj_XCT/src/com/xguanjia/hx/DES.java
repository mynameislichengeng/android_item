...
//	            a[j] = (byte)((a[i] & 0x30) >>> 4);
    ...
    public static void main(String[] args) {
    	DES des = new DES("0123456789abcdefghi@jklmnopqrs#tuvwxyz_ABCDE%FGHIJKLMNOPQRS*TUVWXYZ");
    	try {
			System.out.println(des.encrypt("12345678gfdhjkjlsdfghj''''adfghjk////hjk!!@!").toString());
			System.out.println(des.decrypt("5CSx32attNVMUkkkgGjWQG6-ZS9g2G6ekw2kPatKNZfm53*JNUbCzC3byzF2D1jBJYDHFYmzmd0"));
