...
public class BaseFragmentActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		relativeLayout = new RelativeLayout(BaseFragmentActivity.this);
	...
	protected void showTitleRightImage(
			View.OnClickListener rightButtonClickListener,int drawble) {
		if (null == titleView) {
			return;
		}
	...
	public void functionGuide(final String functionName, int guideImageResources) {
		...
		ImageView imageIv = new ImageView(BaseFragmentActivity.this);
