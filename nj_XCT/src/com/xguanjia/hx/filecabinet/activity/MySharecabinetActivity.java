...
public class MySharecabinetActivity extends BaseActivity {

	private final String TAG = "MySharecabinetActivity";
	...
	private String selectIndex = "2"; // 0个人文件夹，1公共文件夹,2分享文件柜
			...
			public boolean handleMessage(Message msg) {
				...
				case Constants.ZERO:
					...
					if (jsonData != null && "{}".equals(jsonData)) {
						Toast.makeText(MySharecabinetActivity.this, "暂无新联系人",
						...
						intent.setClass(MySharecabinetActivity.this,
	...
	private void initViews() {
		...
		service = new PersonService(MySharecabinetActivity.this);
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if ("false".equals(fileList.get(position).getIsDirectory())) {
				...
				if (FileCacheManager.getCacheFileExists(
						MySharecabinetActivity.this, bean.getFileName())) {
					...
					MySharecabinetActivity.this.startActivity(intent);
				} else {
				...
				if (list != null && !list.isEmpty()) {
					...
					Toast.makeText(MySharecabinetActivity.this, "文件夹下没有内容", 0)
							.show();
				}
			}
		}
	...
	public void getFileListRemote(final String lastFolderTime,
		...
		pd = ProgressDialog.show(MySharecabinetActivity.this, "", "数据刷新中...",
				true, true);
		...
		try {
			ServerAdaptor.getInstance(MySharecabinetActivity.this).doAction(1,
	...
	private void onKeyBack() {
		...
		if (fileList != null && !fileList.isEmpty() && !"2".equals(selectIndex)) {
			...
			if ("".equals(fileList.get(0).getParentId())) {
				MySharecabinetActivity.this.finish();
			} else {
